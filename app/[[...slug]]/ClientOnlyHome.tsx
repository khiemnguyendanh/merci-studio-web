  ...
  loading: () => (
    <main className="min-h-screen bg-slate-50 px-6 py-20 text-slate-900">
      <section className="mx-auto max-w-4xl text-center">
        ...
        <h1 className="mt-5 font-serif text-4xl font-semibold md:text-6xl">Merci Wedding Studio</h1>
        <p className="mx-auto mt-6 max-w-2xl text-base leading-8 text-slate-600">
          Studio chụp ảnh cưới, phóng sự cưới, makeup cô dâu và váy cưới tại Hà Nội, Bắc Ninh.
          Khám phá album thực tế, kinh nghiệm chuẩn bị ngày cưới và đặt lịch tư vấn cùng Merci Studio.
        </p>
